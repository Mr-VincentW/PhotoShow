...
*（注：浮图秀始终被良好维护并持续更新着，但本 repo 内的代码已于版本 4.36.0 后停止更新。）*
<br />
<br />
...
**浮图秀**默认在所有网站工作并持续扩展其专门适配的网站列表，这也是其首次发布历经多年后，最终选择拥抱开源阵营的重要原因之一。详情请参阅[参与指南](#%E5%8F%82%E4%B8%8E%E6%8C%87%E5%8D%97)一节。
...
[点此阅读](https://www.photoshow.cool/terms-zh-cn)

**浮图秀**（4.37.0 前的版本）基于[MIT 开源协议](../LICENSE)发行。当前版本引用了 [jQuery](https://jquery.com/)，遵循 [jQuery 协议](https://jquery.org/license/)。
<br />
<br />
