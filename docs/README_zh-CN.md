...
2.  **购物 / 出行 / 服务 类：**
    ...
    Alibaba、AliExpress、Amazon、Andino、Apple、Apple App Store、Best Buy、Briscoes、Countdown、coupang、DHgate、eBay、Etsy、Google Play、Google Store、instacart、Kmart、Myprotein、Newegg、noel leeming、NZSALE、PBTech、Target、TheMarket、thewarehouse、Torpedo7、Trade Me、TreatMe、Walmart、warehouse stationery、Yelp
...
4.  **新闻 / 社交 / 社区 类：**
    ...
    aewtogether.org、allelitewrestling.com、e621.net、Facebook、IMDb、Imgur、Instagram、JavBus、Konachan、njpwworld.com、Reddit、TapTap、Tumblr、TweetDeck、Twipu、Twitter、wattpad、web-zones.ru、XDA、yande.re

    115 网盘、A 岛匿名版、巴哈姆特、百度贴吧、绅士仓库、豆瓣、堆糖、煎蛋、乐乎、萌娘百科、网易云音乐、NGA 玩家社区、QQ 空间、今日头条、微博、微信公众号

5.  **视频、音乐 类：**

    Acfun、Bandcamp、Discogs、Dizilah、Encyclopaedia Metallum、Fandango、Flixster、kanald.com.tr、Pornhub、radyod.com、Rotten Tomatoes、TikTok、YouTube

    bilibili、抖音、斗鱼、好看视频、爱奇艺、快手、西瓜视频、MX 动漫、优酷、土豆
